...
class Alg_WC_Custom_Order_Statuses_Tool {
	...
	function create_custom_statuses_tool() {
		...
		$html .= '<p><a href="' . admin_url( 'admin.php?page=wc-settings&tab=alg_wc_custom_order_statuses' ) . '">' .
			'<< ' . __( 'Plugin Settings', 'custom-order-statuses-woocommerce' ) . '</a></p>';
		$html .= '<h1>' . __( 'Custom Order Status Tool', 'custom-order-statuses-woocommerce' ) . '</h1>';
		$html .= '<p>' . __( 'The tool lets you add or delete any WooCommerce orders custom status.', 'custom-order-statuses-woocommerce' ) . '</p>';
